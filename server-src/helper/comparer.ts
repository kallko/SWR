...
export const Comparer = {
	// async compareGuildLegendWeekProgress(
	// 	freshGuild: ILegendPlayerProgress[]
	// ): Promise<ILegendPlayerProgress[]> {
	// 	let oldGuildString: string = await readWriteService.readJson(
	// 		'arch/braz12.5.json'
	// 	);
	...
	// 				oldMember.player_name === freshMember.player_name
	// 		);
	// 		let kDiff =
