...
export interface ISet {
  id: number;
  name: 'Speed' | 'Critical Chance'|'Defense' |'Tenacity'| 'Offense' | 'Potency' | 'Health' | 'Critical Damage';
  setCount: 2 | 4
  fullBonus: number
}
...
export interface IMOD_OPTIONS {
  ...
  sets: ISet[];
  secondary: ('Defense' | 'Potency' | 'Offense' | 'Speed' | 'Health' | 'Tenacity' | 'Protection' | 'Critical Chance' | 'Critical Damage')[]
  mainStat: {
